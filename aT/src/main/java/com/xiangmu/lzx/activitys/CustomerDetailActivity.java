...
public class CustomerDetailActivity extends AppCompatActivity implements OnItemSelectedListener{
    Context context =CustomerDetailActivity.this;
    ...
    if (!url.equals("")) {
        ...
        handler = httpUtils.send(HttpRequest.HttpMethod.GET, url, params,new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (responseInfo.result != null) {
                    Toast.makeText(CustomerDetailActivity.this, "注册用户信息修改成功！", Toast.LENGTH_SHORT).show();
...
//                        setResult(RESULT_CODE, intent);
            ...
            @Override
            public void onFailure(HttpException e, String s) {
                Toast.makeText(CustomerDetailActivity.this, "注册用户信息修改失败！", Toast.LENGTH_SHORT).show();
            }
        });
