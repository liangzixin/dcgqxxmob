      ...
      params.addQueryStringParameter("productArticler.id",liuyuan_id.getText().toString());
        ...
        handler = httpUtils.send(HttpRequest.HttpMethod.GET, url, params,new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                if (responseInfo.result != null) {
                    Toast.makeText(SmsMessageDetailActivity.this, "留言信息修改成功！", Toast.LENGTH_SHORT).show();
...
//                        setResult(RESULT_CODE, intent);
            ...
            @Override
            public void onFailure(HttpException e, String s) {
                Toast.makeText(SmsMessageDetailActivity.this, "留言信息修改失败！", Toast.LENGTH_SHORT).show();
            }
        });
...
//        };
    ...
    public void showView(XinWen_productinfo.ShortmessageEntity SmsEntity)
    {
        ...
        liuyuan_id.setText(SmsEntity.getId()+"");
//        liuyuan_content.setText(SmsEntity.getArtreview_content());
//        liuyuan_time.setText(SmsEntity.getArtreview_time());
//       liuyuan_customer.setText(SmsEntity.getCustomer().getUsername());
//       liuyuan_productinfo.setText(SmsEntity.getProduct().getName());
