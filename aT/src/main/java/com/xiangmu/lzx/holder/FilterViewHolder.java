...
public class FilterViewHolder extends ViewHolder implements OnClickListener,OnLongClickListener{
	...
	public FilterViewHolder(View arg0, MyItemClickListener listener, MyItemLongClickListener longClickListener) {
		super(arg0);
