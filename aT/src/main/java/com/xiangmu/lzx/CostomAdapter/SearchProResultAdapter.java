 ...
 */
public class SearchProResultAdapter extends BaseAdapter {
    ...
    public void setList(List<XinWen_productinfo.T18908805728Entity> list) {
        this.list = list;
    }


    public SearchProResultAdapter(List<XinWen_productinfo.T18908805728Entity> list, Context context) {
        this.list = list;
