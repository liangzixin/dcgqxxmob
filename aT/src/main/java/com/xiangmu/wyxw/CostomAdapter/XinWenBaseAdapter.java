...
import com.xiangmu.wyxw.utils.XinWen_toutiao1;
...
public class XinWenBaseAdapter extends BaseAdapter {
    ...
    private List<XinWen_toutiao1.T1348647853363Entity> toutiao_list;
    private Context context;

    public XinWenBaseAdapter(Context context, List<XinWen_toutiao1.T1348647853363Entity> toutiao_list) {
        this.context = context;
        this.toutiao_list = toutiao_list;
    }

    public List<XinWen_toutiao1.T1348647853363Entity> getToutiao_list() {
        return toutiao_list;
    }

    public void setToutiao_list(List<XinWen_toutiao1.T1348647853363Entity> toutiao_list) {
        this.toutiao_list = toutiao_list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (type) {
            ...
            case XinWen_adapter.type_duotu:
                ...
                List<XinWen_toutiao1.T1348647853363Entity.ImgextraEntity> imagextralist=toutiao_list.get(i).getImgextra();
