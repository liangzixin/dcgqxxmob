...
//        toutiao_lv.setPullLoadEnabled(true);
   ...
   // private List<XinWen_toutiao1.T1348647853363Entity> toutiao_list = new ArrayList<>();
   private List<XinWen_productinfo.T18908805728Entity> toutiao_list = new ArrayList<>();
    ...
    private void frament2activity(int position) {
       ...
       // int bujutype = XinWen_adapter.getType(toutiao_list.get(pos).getProductcategory().getId()+"");
        int bujutype =0;
                //传入详细页面的数据
...
//        xinWenXi.setXinwentext(toutiao_list.get(pos).getDigest());//内容
        xinWenXi.setReplaycount(toutiao_list.get(pos).getId());//跟帖数量
        xinWenXi.setTitle(toutiao_list.get(pos).getName());//标题
        xinWenXi.setXinwentext(toutiao_list.get(pos).getName());//内容
        ...
        switch (bujutype) {
            ...
            case XinWen_adapter.TYPE_zhibo:
               ...
               // String urlzhibo = toutiao_list.get(pos).getUrl();
                String urlzhibo = toutiao_list.get(pos).getAds().get(0).getUrl();
            ...
            case XinWen_adapter.type_duotu:
               ...
               // String urlduotuRight = toutiao_list.get(pos).getSkipID();
                String urlduotuRight = toutiao_list.get(pos).getId().toString();
