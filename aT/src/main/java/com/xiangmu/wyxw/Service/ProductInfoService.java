...
import com.xiangmu.wyxw.utils.ToolsHandler;
...
//     * @return List<Tfoods> foods
//     */
//    public List<ProductInfo> queryTodayBirthday() throws Exception
//    {
//        String path = HttpUtil.BASE_URL+"productInfo!queryTodayBirthday.action";
//        URL url;
//        try {
//            url = new URL(path);
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
...
//     * @return List<Tfoods> foods
//     */
//    public List<ProductInfo> queryToday7Birthday() throws Exception
//    {
//        String path = HttpUtil.BASE_URL+"productInfo!queryToday7Birthday.action";
//        URL url;
//        try {
//            url = new URL(path);
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
...
//     * @return Ttables
//     */
//    public ProductInfo queryTxxxId(int  id) throws Exception {
//
//
//        String path = HttpUtil.BASE_URL+"productInfo!queryTxxxId.action?id="+id+"";
//        URL url;
//        try {
//            url = new URL(path);
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
...
//     * @return Ttables
//     */
//    public List<ProductInfo> queryTxxxName(Map map)
//    {
//
//        String path=HttpUtil.BASE_URL+"productInfo!queryTxxxName.action";
//
...
//     * @return Ttables
//     */
//    public List<ProductInfo> queryTxxxOther(Map map)
//    {
//
//        String path=HttpUtil.BASE_URL+"productInfo!queryTxxxOther.action";
//
//        json=loginPostData(path, map);
////        System.out.println(json);
//        txxxs=getGson().fromJson(json, new TypeToken<List<ProductInfo>>() {}.getType());
...
//    {
//        String path=HttpUtil.BASE_URL+"productInfo!updateTxxxId.action";
//
...
//    {
//        int count=0;
//        String path=HttpUtil.BASE_URL+"productInfo!queryTxxxOtherCount.action";
//
//        String result =loginPostData(path, map);
//        if( result!="0")
//        {
...
//    {
//
//        String path = HttpUtil.BASE_URL+"productInfo!queryTxxxCount.action";
//        URL url;
//        try {
//            url = new URL(path);
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
